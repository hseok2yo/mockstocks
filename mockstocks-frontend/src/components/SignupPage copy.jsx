...
import { useVerificationTimer } from "@/hooks/common/useVerificationTimer";
...
function SignupPage() {
  ...
  const emailVerify = useVerificationTimer(180);
        ...
        <form className="auth-form">
          ...
          <div className="input-with-button">
            ...
            <button
              type="button"
              className="verify-button"
              onClick={() => emailVerify.handleSendCode(email)}
              disabled={emailVerify.isVerified}
            >
          ...
          {emailVerify.isSent && !emailVerify.isVerified && (
            <div className="input-with-button">
              ...
              <button
                type="button"
                className="verify-button"
                onClick={() => emailVerify.handleVerifyCode(email)}
          ...
          {emailVerify.isSent && !emailVerify.isVerified && (
            <p style={{ color: emailVerify.isExpired ? "red" : "gray", margin: "0" }}>
              {emailVerify.isExpired
                ? "인증 시간이 만료되었습니다."
                : `남은 시간: ${emailVerify.formattedTime}`}
            </p>
          )}
